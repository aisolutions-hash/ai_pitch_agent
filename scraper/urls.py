...
urlpatterns = [
    ...
    path('locations/', views.scrape_locations_list, name='scrape-locations-list'),
    path('locations/add/', views.scrape_location_add, name='scrape-location-add'),
    path('locations/toggle/', views.scrape_location_toggle, name='scrape-location-toggle'),
    path('locations/delete/', views.scrape_location_delete, name='scrape-location-delete'),
